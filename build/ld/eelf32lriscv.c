...
static void gldelf32lriscv_after_parse (void);
...
static void
gldelf32lriscv_after_parse (void)
{
...
OUTPUT_ARCH(riscv)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/home/majiahao/ddddd/riscv-binutils-install/riscv64/lib\");\n\
SECTIONS\n\
{\n\
